    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String nom = Utils.capitalizePalabra(nombre.getText().toString());
                String ape = Utils.capitalizePalabra(apellidos.getText().toString());
                String tlf = telefono.getText().toString();

                if (!nom.isEmpty() && !tlf.isEmpty()) {
                    if (ConnectDB.con(AddActivity.this) != null) {
                        ConnectDB.con(AddActivity.this).execSQL("INSERT INTO Cliente (nombre, apellidos, telefono, num_pelados) VALUES ('" + nom.trim() + "', '" + ape.trim() + "', " + tlf.trim() + ", 0)");
                    }
