...
public class Consultas {
    ...
    public static ArrayList<Cliente> consultarTodos(Context contexto){
        ...
        if (ConnectDB.con(contexto) != null) {
            ...
            if (c.moveToFirst()) {
                do {
                    lista_clientes.add(new Cliente(c.getString(0), c.getString(1), c.getInt(2)));
                } while (c.moveToNext());
            }
    ...
    public static Cliente obtenerClientePorNombre(Context contexto, String nombre){
        ...
        if (ConnectDB.con(contexto) != null) {
            ...
            Cursor c = ConnectDB.con(contexto).query("Cliente", campos, "nombre=?", args, null, null, null);

            if (c.moveToFirst()) {
                do {

                    cliente = new Cliente(c.getString(0),c.getString(1),c.getInt(2),c.getInt(3));
